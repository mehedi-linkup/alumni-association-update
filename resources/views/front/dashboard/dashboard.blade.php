                  ...
                  <div class="col-sm-9">
                                      ...
                                      <div class="row">
                                          <div class="col-md-3">
                                              <div class="profile-work">
                                                  <p>Passing Year</p>
                                                  <a
                                                      href="">{{ Auth::guard('participant')->user()->passing_year }}</a><br />
                                                  <p>Blood Group</p>
                                                  <a href=""></a><br />
                                              </div>
                                          </div>
                                      ...
                                      <fieldset>
                                          <div class="card-body shadow p-3 mb-5 bg-white rounded">
                                              <form id="frmCheckout" action="{{ route('participant.update-participant') }}"
                                                  ...
                                                  <div class="row">
                                                      <div class="col-md-6">
                                                          <input id="participant_id" type="hidden" name="participant_id"
                                                      ...
                                                      <div class="col-md-6">
                                                          <div class="form-group">
                                                              ...
                                                              <input class="form-control" name="fathers_name"
                                                                  type="text"
                                                      ...
                                                      <div class="col-md-6">
                                                          <div class="form-group">
                                                              ...
                                                              <select id="passing_year" class="form-control"
                                                                  name="passing_year">
                                                                  <option selected disabled value=""> Select Passing
                                                                      Year
                                                                  </option>
                                                      ...
                                                      <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                          ...
                                                          <select name="dress" id="dress" class="form-control">
                                                              ...
                                                              <option value="M"
                                                                  @php
                                                                      if (Auth::guard('participant')->user()->dress == 'M') {
                                                                      echo 'selected';
                                                                  } @endphp>
                                                                  M</option>
                                                              <option value="L"
                                                                  @php
                                                                      if (Auth::guard('participant')->user()->dress == 'L') {
                                                                      echo 'selected';
                                                                  } @endphp>
                                                                  L</option>
                                                              <option value="XL"
                                                                  @php
                                                                    if (Auth::guard('participant')->user()->dress == 'XL') {
                                                                      echo 'selected';
                                                                  } @endphp>
                                                                  XL</option>
                                                              <option value="XXL"
                                                                  @php
                                                                    if (Auth::guard('participant')->user()->dress == 'XXL') {
                                                                      echo 'selected';
                                                                  } @endphp>
                                                                  XXL</option>
                                                              <option value="XXXL"
                                                                  @php
                                                                    if (Auth::guard('participant')->user()->dress == 'XXXL') {
                                                                      echo 'selected';
                                                                  } @endphp>
                                                                  XXXL</option>
                                                          </select>
                                      ...
                                      <div class="col-lg-5">
                                          <div class="card frontpart shadow p-2">
                                              ...
                                              <div class="profile-image">
                                                  ...
                                                  @elseif(Auth::guard('participant')->user()->gender == 'Male')
                                                      <img src="{{ asset('front/images/male.png') }}" class="float-left"
                                                          alt="">
                                                  @else
                                                      <img src="{{ asset('front/images/female.png') }}" class="float-left"
                                                          alt="">
                                                  @endif
                                                  <h5>Batch</h5>
                                              ...
                                              <div class="footer-img">
                                                  ...
                                                  <img class="w-50" src="{{ asset('front/images/card-Qr.png') }}"
                                                      alt="">
                                              </div>
                                          </div>
                      ...
                      @else
                          <?php $payment = DB::table('transaction')
                              ...
                              ->first(); ?>
                          <div class="card-body">
                              <h3 class="received-title">Received Payment Info</h3>
                              <div id="print_section">
                                <div class="row invoice">
                                    <div class="col-12 col-md-8 offset-md-2 row-printable set-box-shadow set-padding set-margin">
                                                ...
                                                <div class="row" style="display: flex; padding-bottom:6px">
                                                    ...
                                                    <div class="col-md-12 col-sm-12">
                                                        ...
                                                        <div class="signeture pt-10" style="">
                                                            <p style="border-top: 1px solid #0d0808;text-align:left">
                                                                Signature</p>
                                                        </div>
                                          ...
                                          <div class="container">
                                              ...
                                              <div class="form-top shadow p-3">
                                                  ...
                                                  <div class="update-password">
                                                      <button type="submit"
                                                          class="btn btn-success btn-large">Update</button>
                                                  </div>
                                              </div>
                                          </div>
                                      </div>
...
<script>
  function invoiceprint() {
    let invoiceContent = document.querySelector('#print_section').innerHTML;
